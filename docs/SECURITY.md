...
- `app.open`, `browser.open`, and `browser.search` are the only capabilities with real side effects wired to the dispatcher; everything else currently wired is read-only.
