...
- Runtime assembly tests cover injecting and exposing the `ConfirmationService` so the future confirmation dialog can share the same bound, expiring, single-use approval primitive as policy tests.
